...
function setup() {
  ...
  bk=createSprite(width-200,height-200)
  bk.addImage(bkI);
  bk.scale=1.3;
  ...
  ground = createSprite(width-265,height-50,width,10);
...
background("white");
 ...
 if(gameState===1){
   ...
   if(touches.length>0||keyDown("space")&& monkey.y>=352.95){
     monkey.velocityY=-15;
     touches=[];
   }
...
function objects(){
  if(frameCount%180===0){
    var obstacle=createSprite(width+20,height-85,20,20)
